...
class PageCell: UICollectionViewCell {
    var page: Page? {
        didSet {
            ...
            let attributeText = NSMutableAttributedString(string: page.title, attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 20, weight: UIFont.Weight.medium), NSAttributedString.Key.foregroundColor: color])
    ...
    let imageView: UIImageView = {
      ...
      //  iv.contentMode = .scalespacefill
        iv.backgroundColor = .yellow
        iv.image = UIImage(named: "fjords")
